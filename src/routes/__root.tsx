      ...
      <head>
        ...
        <script
          dangerouslySetInnerHTML={{
            __html:
              "try{var t=localStorage.getItem('theme');var m=window.matchMedia('(prefers-color-scheme: dark)').matches;if(t?t==='dark':m){document.documentElement.classList.add('dark')}}catch(e){}",
          }}
        />
      </head>
      <body>
